...
contact info, and more. No private information like Credit Card numbers is available.
     ...
     *     - contact array Contact details for the account
     ...
     *         - data array Any extra data associated with this module as key=>value pairs
     ...
     *     - rewards array Rewards details for the account including credits & inspections earned, number of referrals, referral details, and rewards used
...
It's also not just Lynx and is very fine tuned for our template layouts - your mileage may vary.
     ...
     * @return array the content pass in converted to text.
...
string back that will explain our view on what is going on.
     ...
     * @return array containing the total matches and current results
     ...
     *     - campaign array the matching campaign's details - will return same data as single campaign from campaigns/list()
     */
     ...
     *     - exact_matches array containing the exact email address matches and current results
     ...
     *     - full_search array containing the total matches and current results
     *         - total int total members matching
     *         - members array each entry will be struct matching  the data format for a single member as returned by lists/member-info()
     */
