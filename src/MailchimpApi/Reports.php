...
class Reports {
     ...
     * @return array abuse report data for this campaign
...
Messages over 30 days old are subject to being removed
     ...
     *     - member array the member record as returned by lists/member-info()
...
messages over 30 days old are subject to being removed
     ...
     *     - limit int optional for large data sets, the number of results to return - defaults to 25, upper limit set at 100
     *     - since string optional pull only messages since this time - 24 hour format in <strong>GMT</strong>, eg "2013-12-30 20:30:00"
     * @return array data for the full bounce messages for this campaign
     ...
     *         - member array the member record as returned by lists/member-info() that received this campaign and is associated with this order
     ...
     * @param string $cid
     * @return array containing tweets, retweets, clicks, and referrer related to using the campaign's eepurl
     *     - twitter array various Twitter related stats
     ...
     *     - clicks array stats related to click-throughs on the eepurl
...
or campaignEmailStatsAIMAll() and generate any additional stats they require.
     ...
     * @return array details for the shared report, including:
     ...
     * @param string $cid
     * @return array the statistics for this campaign
     ...
     *     - industry array Various rates/percentages for the account's selected industry - empty otherwise. These will vary across calls, do not use them for anything important.
     ...
     *     - absplit array If this was an absplit campaign, stats for the A and B groups will be returned - otherwise this is empty
     ...
     *     - start int optional for large data sets, the page number to start at - defaults to 1st page of data  (page 0)
     *     - limit int optional for large data sets, the number of results to return - defaults to 25, upper limit set at 100
     * @return array a total of all unsubscribed emails and the specific members for this page
