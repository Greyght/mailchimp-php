...
class Templates {
     ...
     * @param int $template_id
     * @param string $type
     * @return array info to be used when editing
     *     - default_content array the default content broken down into the named editable sections for the template - dependant upon template, so not documented
     *     - sections array the valid editable section names - dependant upon template, so not documented
