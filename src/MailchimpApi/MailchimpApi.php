<?php namespace Mailchimp\MailchimpApi;
...
foreach (glob("../Exceptions/Mailchimp*.php") as $filename)
{
    require_once $filename;
}

use Mailchimp\Exceptions\Mailchimp_Error;
use Mailchimp\Exceptions\Mailchimp_HttpError;
...
class MailchimpApi {
    ...
    public static $error_map = array(
        ...
        "Absplit_UnknownSplitTest" => "Mailchimp_Absplit_UnknownSplitTest\Mailchimp_Absplit_UnknownSplitTest",
